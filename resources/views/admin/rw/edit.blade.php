        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card border-danger">
                    ...
                    <form action="{{ route('rw.update',$rw->id)}}" method="post"> @method('PUT') @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" value="{{$rw->nama_rw}}" required  id="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_kel" id="">
                                            @foreach ($kelurahan as $data)
                                                <option value="{{$data->id}}" <?= ($data->id == $rw->id_kel)? 'selected' : ''?>>{{$data->nama_kel}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
